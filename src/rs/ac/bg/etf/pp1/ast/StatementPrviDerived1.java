...
public class StatementPrviDerived1 extends StatementPrvi {

    private SingleStatement SingleStatement;

    public StatementPrviDerived1 (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementPrviDerived1(\n");
